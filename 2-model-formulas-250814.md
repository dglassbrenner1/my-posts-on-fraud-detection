...
The $(i,j)$th entry $X_{ij}$ 
of $\mathbf{X}$ 
is the value of the $j$th feature in the $i$th sample. We will sometimes use $y$ to denote the random variable from which the class data was generated, e.g. 
